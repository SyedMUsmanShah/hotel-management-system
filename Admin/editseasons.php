...
if(isset($_POST["submit"])){
    ...
    $insert = "UPDATE seasons SET name = '$Season', start = '$Season_start', end = '$Season_end' WHERE id=$id";
...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <form action="" method="post" class="season-form">
                ...
                <input class="form-control" type="text" name="season" id="season" value="<?php echo $main["name"] ?>">
                <label for="start" class="title">Season Start</label>
                <input class="form-control" type="date" name="startDate" id="start" value="<?php echo $main["start"] ?>">
                <label for="end" class="title">Season End</label>
                <input class="form-control" type="date" name="endDate" id="end" value="<?php echo $main["end"] ?>">
                <?php } ?>
