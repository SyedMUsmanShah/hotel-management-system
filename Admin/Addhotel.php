...
if (isset($_POST["submit"])) {
    ...
    if (move_uploaded_file($tmp_image, '../img/' . $logo)) {
    ...
    // hotel-stars-table 
    $stars = $_POST["stars"];
    mysqli_query($connection, "INSERT INTO stars(stars,hotelid)VALUE('$stars','$hotelid')");
    ...
    foreach ($_FILES["multipleimages"]["tmp_name"] as $key => $value) {
        ...
        if (move_uploaded_file($tmp_image, '../img/' . $detailimages)) {
            mysqli_query($connection, "INSERT INTO hotelimages (images,hotelid) VALUE ('$detailimages','$hotelid')");
        }
    }
    ...
    foreach ($_POST["services"] as $service_key => $service_value) {
        ...
        mysqli_query($connection, "INSERT INTO hotelservices (service,hotelid) VALUE ('$serv','$hotelid')");
    }
    ...
    foreach ($_POST["features"] as $features_key => $features_value) {
        ...
        mysqli_query($connection, "INSERT INTO hotelfeatures (feature,hotelid) VALUE ('$featu','$hotelid')");
    }
    ...
    foreach ($_POST["room"] as $key => $rooms) {
        ...
        mysqli_query($connection, "INSERT INTO rates(room,rate,no_of_rooms,season,hotelid)VALUE('$rooms','$rate','$no','$seasons','$hotelid')");
        }
    }
}
?>
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <form action="" method="post" class="hotel-form" enctype="multipart/form-data">
                ...
                <input type="text" class="form-control" name="distance" placeholder="Enter distance from Airport">
                <input type="text" class="form-control" name="shuttle" placeholder="Enter shuttle hours">
                <div class="check-box">
                ...
                <div class="rate-box">
                    ...
                    <div class="rates">
                        ...
                        <label for="no-of-rooms">No. of Rooms</label><input type="text" name="no_of_rooms[]" id="no-of-rooms" class="form-control room" placeholder="No of Room">
                    </div>
                </div>
