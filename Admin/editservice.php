...
if(isset($_POST["submit"])){
    ...
    $insert = "UPDATE services SET serviceName = '$Service', faIcon = '$icon' WHERE id=$id";
...
<body>
    ...
    <form action="" method="post" class="services-form">
                ...
                <input id="" class="form-control" type="text" name="Service" placeholder="Enter your services" value="<?php echo $main["serviceName"] ?>">
